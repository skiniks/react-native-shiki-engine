...
public:
  ...
  void updateView(void *view, const std::vector<Token> &tokens,
  ...
  void
  renderIncrementalHighlights(const std::vector<IncrementalUpdate> &updates,
...
private:
  ...
  void computeLayoutInBackground(NSAttributedString *styledText,
                                 void *targetView);
  ...
  void applyStyle(const ThemeStyle &style, void *attributedString,

...
namespace react {
  ...
  ShikiHighlighterProps::ShikiHighlighterProps(const PropsParserContext& context,
      ...
      : ViewProps(context, sourceProps, rawProps),
        ...
        fontWeight(convertRawProp(context, rawProps, "fontWeight", sourceProps.fontWeight,
                                  sourceProps.fontWeight)),
        fontStyle(convertRawProp(context, rawProps, "fontStyle", sourceProps.fontStyle,
                                 sourceProps.fontStyle)),
        showLineNumbers(convertRawProp(context, rawProps, "showLineNumbers",
                                       sourceProps.showLineNumbers, sourceProps.showLineNumbers)),
        text(convertRawProp(context, rawProps, "text", sourceProps.text, sourceProps.text)),
        language(convertRawProp(context, rawProps, "language", sourceProps.language,
                                sourceProps.language)),
